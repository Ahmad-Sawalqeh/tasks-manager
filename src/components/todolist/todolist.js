...
function ToDoList(props){
    ...
    const { list, completed, deleteItem, itemToEdit, itemsToShow, wantedListToShow, deleteCompletedItem, hideAllItems, toggleItems, clearList } = props;
        ...
        <>
            <div>
                ...
                <div className='text-center'>
                    <button className='btn btn-primary mb-3 mr-3' onClick={hideAllItems}>
                    ...
                    <button className='btn btn-warning mb-3 mr-3' onClick={deleteCompletedItem}>Delete all completed items</button>
                </div>
